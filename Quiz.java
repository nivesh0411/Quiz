...
public class Quiz implements ActionListener {
    ...
    String[][] options = { { "Rises slowly ", " Rises quickly ", "Decays slowly", "Decays quickly" },
            ...
            { " Analytic ", "Parabolic", " Transfer", " Hypothetical" }, { "C(s)/R(s)=G(s)/1+G(s)H(s)",
                    "C(s)/R(s)=G(s)H(s)/1-G(s)H(s)", "C(s)/R(s)=G(s)/1+G(s)H(s)", "C(s)/R(s)=G(s)/1-G(s)H(s)" } };
    char[] answers = { 'D', 'B', 'D', 'C', 'D', };
    char guess;
    char answer;
    int index;
